...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LibraryCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => LibraryCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => LibraryCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => StreamCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => StreamCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => StreamCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
