...
import { LibraryFindManyArgs } from "../../library/base/LibraryFindManyArgs";
...
export class UserControllerBase {
  ...
  @common.Get("/:id/libraries")
  @ApiNestedQuery(LibraryFindManyArgs)
  async findLibraries(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Library[]> {
    const query = plainToClass(LibraryFindManyArgs, request.query);
    const results = await this.service.findLibraries(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/libraries")
  async connectLibraries(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: LibraryWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      libraries: {
        connect: body,
  ...
  @common.Delete("/:id/libraries")
  async disconnectLibraries(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: LibraryWhereUniqueInput[]
  ): Promise<void> {
    const data = {
